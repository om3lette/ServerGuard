...
from src.constants import ExitStatus, ADMINS, ADMIN_IDS, SECONDS_BETWEEN_RETRIES, SERVER_ADDRESS
...
async def default_ping_error_callback(request_message: Message, attempt_number: int, is_attempt_final: bool = False):
    ...
    for admin_id in ADMIN_IDS:
        await bot.send_message(admin_id, PING_HANGUP_ADMIN_MESSAGE.format(server_address=SERVER_ADDRESS))
